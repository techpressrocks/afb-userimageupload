...
function auiu_feat_img_html( $attach_id ) {
    ...
    $html .= sprintf( '<a class="auiu-del-ft-image button" href="#" data-id="%d">%s</a> ', $attach_id, __( 'Remove Image', 'auiu' ) );
...
add_action( 'wp_head', 'auiu_error_message_css', 999 );
function auiu_error_message_css() {
	$checkbox_error = auiu_get_option( 'checkbox_error', 'auiu_labels' );
	?>
	<style type="text/css">
		.auiu-check-container span.invalid:after {
			content: "  - <?php echo $checkbox_error; ?>";
		}	
	</style>
<?php
}	
...
function auiu_custom_styles() {
	...
	$label_width = (int) auiu_get_option( 'label_width', 'auiu_styles' );
	$text_width = (int) auiu_get_option( 'text_width', 'auiu_styles' );
	...
	<style type="text/css">
		...
		.auiu-post-form input[type="submit"], #auiu-ft-upload-container, .auiu-post-form p.description, .auiu-post-form span.description { {
			margin-left: <?php echo $label_width; ?>%;
		}	
		.auiu-post-form input[type=text], .auiu-post-form textarea, .auiu-post-form .auiu-check-container, .g-recaptcha {
